...
namespace OpenCVForUnityExample
{
    ...
    public class VideoCaptureExample : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            capture = new VideoCapture();// "rtsp://210.99.70.120:1935/live/cctv001.stream", Videoio.CAP_FFMPEG);
            ...
            //capture.open("rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov", Videoio.CAP_FFMPEG);
            capture.open("rtsp://admin:admin@192.168.40.201:554/cam/realmonitor?channel=1&subtype=1", Videoio.CAP_FFMPEG);
        ...
        private void Initialize()
        {
            ...
            if (!capture.isOpened())
            {
                Debug.LogError("" + " is not opened. Please move from “OpenCVForUnity/StreamingAssets/” to “Assets/StreamingAssets/” folder.");
            }
            ...
            //capture.set(Videoio.CAP_PROP_FPS, (int)30);
        ...
        private IEnumerator WaitFrameTime()
        {
            ...
            Debug.Log("Delay : " + frameTime_sec.ToString("F1"));
